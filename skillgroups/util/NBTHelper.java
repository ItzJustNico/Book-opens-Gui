...
import com.nico.skillgroups.tileentity.RubyBlockTileEntity;
...
public class NBTHelper {
    ...
    public static CompoundNBT toNBT(Object o) {
        ...
        if(o instanceof RubyBlockTileEntity) {
            return writeQuarry((RubyBlockTileEntity)o);
        }

        return null;
    }

    private static CompoundNBT writeQuarry(RubyBlockTileEntity o) {
